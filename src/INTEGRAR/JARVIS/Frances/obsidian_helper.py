...
def creer_ou_modifier_note(titre, contenu):
    ...
    try:
        ...
        return True, f"Note '{titre}' créée dans votre coffre Obsidian, Mickael."
...
def lire_note(titre):
    ...
    if not os.path.exists(filepath):
        return False, f"La note '{titre}' n'existe pas dans le coffre, Mickael."
...
def supprimer_note(titre):
    ...
    try:
        ...
        return True, f"La note '{titre}' a été supprimée de votre coffre Obsidian, Mickael."
    except Exception as e:
