...
try:
    import pyautogui  # opcional para automatización de escritorio
except ImportError:
    pyautogui = None
try:
    import numpy as np  # opcional; reservado para futuras funciones multimedia
except ImportError:
    np = None
...
# ----------------------------------------------------------------------
# Funciones locales de detección de SO (evita dependencia externa)
# ----------------------------------------------------------------------
...
def _summarize_with_gemini(transcript: str, video_url: str) -> str:
    from src.config.config import gemini_generate
    ...
    try:
        return gemini_generate(prompt, system_instruction=system)
    except Exception as e:
