# src/actions/aircraft_module.py
import os
import math
import time
import requests
...
# Importación integrada: edge_speak desde la UI, con soporte para None como player
from src.ui.voice_player import edge_speak
...
def speak_detailed_aircraft_report(player):
    ...
    if not planes:
        ...
        edge_speak(text, player)  # player puede ser None (solo audio)
        if player:
