...
"""
Gestión de configuración para AP0L0.
Maneja el archivo api_keys.json y todas las configuraciones del sistema.
"""
import json
import sys
...
def get_llm_config() -> dict:
    """Devuelve la configuración del LLM (url, modelo, proveedor)."""
    cfg = load_api_keys()
    return {
...
def get_stt_engine() -> str:
    return load_api_keys().get("stt_engine", "whisper")

def get_tts_engine() -> str:
    return load_api_keys().get("tts_engine", "edgetts")