...
from src.core.config import gemini_generate, PLANNER_MODEL
from src.core.logging import get_logger

log = get_logger("jarvis.error_handler")
...
Attempt number: {attempt}"""
    ...
    try:
        text = gemini_generate(prompt, model=PLANNER_MODEL, system_instruction=ERROR_ANALYST_PROMPT).strip()
...
Return ONLY the Python code, no explanation."""
    ...
    try:
        code = gemini_generate(prompt, model=PLANNER_MODEL).strip()
